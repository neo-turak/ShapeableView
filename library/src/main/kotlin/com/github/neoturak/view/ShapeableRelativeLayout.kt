...
class ShapeableRelativeLayout : RelativeLayout {
    ...
    private fun initView(context: Context?, attrs: AttributeSet?) {
        val ta = context!!.obtainStyledAttributes(attrs, R.styleable.ShapeableRelativeLayout)
        //全部边框值
        ...
        //开始颜色
        startColor =
            ta.getColor(R.styleable.ShapeableRelativeLayout_gradient_startColor, 0)
        //中间颜色
        centerColor =
            ta.getColor(R.styleable.ShapeableRelativeLayout_gradient_centerColor, 0)
        //结束颜色
        endColor = ta.getColor(R.styleable.ShapeableRelativeLayout_gradient_endColor, 0)
        //角度值
        angle = ta.getInteger(R.styleable.ShapeableRelativeLayout_gradient_angle, 6)
        //是否要剪切child
        cutChild = ta.getBoolean(R.styleable.ShapeableRelativeLayout_cut_child, false)
        ta.recycle()
        setAttrs()
    }
