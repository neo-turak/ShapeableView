...
class ShapeableAppBarLayout : AppBarLayout {
    ...
    private fun initView(context: Context?, attrs: AttributeSet?) {
        ...
        cornerBottomLeft =
            ta.getDimension(R.styleable.ShapeableAppBarLayout_shape_cornerBottomLeft, 0F)
        cornerBottomRight =
            ta.getDimension(R.styleable.ShapeableAppBarLayout_shape_cornerBottomRight, 0F)
        //边框颜色
